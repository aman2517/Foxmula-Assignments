...
--> Solution in StackImp.java and Stack.java file.
...
--> Solution in TestQuadrilateral.java, Quadrilateral.java, Square.java, Rectangle.java, Parallelogram.java, Trapezoid.java file.
